    ...
    const obtenerEmpleados = async () => {
        try {
            ...
            if (idusuario) {
                ...
                // Set the default selected employee
    ...
    return (
        <div className="p-6 bg-[#f9f9f9] dark:bg-[#1E1E2F] min-h-screen">
            ...
            <div className="flex justify-center mb-4 gap-2">
                <div className="border rounded-lg px-2 py-1 bg-white dark:bg-[#2D2D3B] text-black dark:text-white shadow-md">
...
export default ConsultarPlanillaPagada;
