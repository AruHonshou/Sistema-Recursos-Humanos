...
const AguinaldoReportes = () => {
  ...
  return (
    <div className="p-6 bg-[#f9f9f9] dark:bg-[#1E1E2F] min-h-screen">
      <h1 className="text-2xl font-bold mb-4 text-black dark:text-white text-center">Reportes de Aguinaldo</h1>
...
export default AguinaldoReportes;
